...
class WindowsCitrixInputProvider(CitrixInputProvider):
    def click(self, x: int, y: int) -> None:
        ...
        v_x = ctypes.windll.user32.GetSystemMetrics(SM_XVIRTUALSCREEN)
        v_y = ctypes.windll.user32.GetSystemMetrics(SM_YVIRTUALSCREEN)
        v_w = ctypes.windll.user32.GetSystemMetrics(SM_CXVIRTUALSCREEN)
        v_h = ctypes.windll.user32.GetSystemMetrics(SM_CYVIRTUALSCREEN)
